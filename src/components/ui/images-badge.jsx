  ...
  return (
    <Component
      ...
      <motion.div
        ...
        {/* Folder Back */}
        <div
          className="absolute inset-0 rounded-[4px] bg-linear-to-b from-amber-400 to-amber-500 shadow-sm dark:from-amber-500 dark:to-amber-600">
          {/* Folder Tab */}
          <div
      ...
      {/* Text */}
      <span className="text-xs font-main font-medium text-gray-400 dark:text-neutral-400">
        {text}
      </span>
    </Component>
  );
